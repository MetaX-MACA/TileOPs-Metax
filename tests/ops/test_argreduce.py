    ...
    PARAMS = [
        (
            ...
            [
                ...
                pytest.param(256, 4096, torch.float16, marks=[pytest.mark.full, pytest.mark.xfail(reason="MACALaunch mcErrorMemoryValueTooLarge")]),
                pytest.param(256, 4096, torch.bfloat16, marks=[pytest.mark.full, pytest.mark.xfail(reason="MACALaunch mcErrorMemoryValueTooLarge")]),
