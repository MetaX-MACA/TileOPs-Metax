...
class DeltaNetFwdFixture(FixtureBase):
    PARAMS = [
        ("batch, seq_len, heads, dim_k, dim_v, chunk_size, dtype, tune", [
            ...
            pytest.param(2, 8192, 4, 64, 64, 64, torch.float16, False, marks=[pytest.mark.full, pytest.mark.skip(reason="Tensor-likes are not close (nan)")]),
            pytest.param(2, 16384, 4, 64, 64, 64, torch.float16, False, marks=[pytest.mark.full, pytest.mark.skip(reason="Tensor-likes are not close (nan)")]),
        ]),
    ]
