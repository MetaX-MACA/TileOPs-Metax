...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param((4, 8), (1, 8), (4, 1), torch.bfloat16, marks=pytest.mark.xfail(reason="tvm.error.InternalError")),  # mixed broadcast
...
@pytest.mark.smoke
@pytest.mark.xfail(reason="tvm.error.InternalError")
@pytest.mark.parametrize(
