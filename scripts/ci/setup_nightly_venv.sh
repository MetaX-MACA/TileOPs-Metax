...
pip install --target=/data/cache/site-packages --no-deps 3rdparty/tilelang-metax/3rdparty/tvm/3rdparty/tvm-ffi/dist/apache_tvm_ffi-0.1.3.dev11+gae346ec92.d20260616-cp312-abi3-linux_x86_64.whl
